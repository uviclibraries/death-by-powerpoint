...
- **What are the most interesting facts or pieces of information in the document or topic?** For example, in the Makerspace Badging article, the methods section of the article really isn't that interesting to a general audience, but the _Results_ and _Discussion_ sections (and to a lesser extent the _Literature Review_) have interesting facts and take-a-ways.
...
**Please copy these 7 key points and paste them into a Word or Google Doc so that you can easily use them as the starting point for 7 slides in your slide deck.**
