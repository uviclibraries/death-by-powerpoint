...
**Please copy copy the above title, and 5 key story points and paste them into the same Word or Google Doc you used in the previous activity.**

In the next activity, we will use these key points to tell a memorable short story at the beginning of our presentation, to set the stage for the important information to follow.
